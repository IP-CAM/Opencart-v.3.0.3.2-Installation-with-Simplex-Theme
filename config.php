<?php
// HTTP
define('HTTP_SERVER', 'http://simplex.dev.it-lab.md/');

// HTTPS
define('HTTPS_SERVER', 'http://simplex.dev.it-lab.md/');

// DIR
define('DIR_APPLICATION', '/var/www/simplex/data/www/simplex.dev.it-lab.md/catalog/');
