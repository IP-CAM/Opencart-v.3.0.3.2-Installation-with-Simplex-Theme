      ...
      <div id="tab-tf-general" class="tab-pane fade in active">
        <div class="panel mz-panel-default">
          <div class="panel-body">
            ...
            <!--Cache-->
            <div class="form-group">
              <label class="col-xs-3 control-label"><?php echo $entry_cache ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
              <div class="col-xs-9">
                <div class="mz-switch-field">
                  <input disabled type="radio" name="cache" value="1" id="input-cache-enabled" >
                  <label for="input-cache-enabled"><?php echo $text_enabled; ?></label>
                  <input disabled type="radio" name="cache" value="0" id="input-cache-disabled" checked>
        ...
        <div class="panel mz-panel-vertical-nav">
          <div class="panel-body clearfix">
            <ul id="tab-tf-filter" class="nav nav-tabs mz-panel-nav-vertical-tabs col-xs-2">
              ...
              <li><a href="#tab-tf-filter-search" data-toggle="tab"><?php echo $entry_search ?> <span class="label label-primary"><?php echo $text_pro ?></span></a></li>
              <li><a href="#tab-tf-filter-availability" data-toggle="tab"><?php echo $entry_availability ?></a></li>
              <li><a href="#tab-tf-filter-discount" data-toggle="tab" class="pro"><?php echo $entry_discount ?> <span class="label label-primary"><?php echo $text_pro ?></span></a></li>
              <li><a href="#tab-tf-filter-rating" data-toggle="tab" class="pro"><?php echo $entry_rating ?> <span class="label label-primary"><?php echo $text_pro ?></span></a></li>
              <li><a href="#tab-tf-filter-filter" data-toggle="tab"><?php echo $entry_filter ?></a></li>
              <li><a href="#tab-tf-filter-custom" data-toggle="tab" class="pro"><?php echo $entry_custom ?> <span class="label label-primary"><?php echo $text_pro ?></span></a></li>
            </ul>
            <div id="tab-tf-filter-content" class="tab-content col-xs-10">
              ...
              <div id="tab-tf-filter-manufacturer" class="tab-pane fade">
                ...
                <!--Input types-->
                <div class="form-group">
                  <label class="col-xs-3 control-label" for="input-tf-filter-manufacturer-input-type"><?php echo $entry_input_type ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
                  <div class="col-xs-9">
                    <select disabled name="filter[manufacturer][input_type]" id="input-tf-filter-manufacturer-input-type" class="form-control disabled">
                      <?php foreach($input_types as $input_type){ ?>
                        <?php if($input_type['code'] == 'checkbox'){ ?>
                ...
                <!--List types-->
                <div class="form-group">
                  <label class="col-xs-3 control-label" for="list-tf-filter-manufacturer-list-type"><?php echo $entry_list_type ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <?php foreach($list_types as $list_type){ ?>
                        <?php if($list_type['code'] == 'text'){ ?>
                        <input disabled type="radio" name="filter[manufacturer][list_type]" value="<?php echo $list_type['code'] ?>" id="input-tf-filter-manufacturer-list-type-<?php echo $list_type['code'] ?>" checked>
                        <label for="input-tf-filter-manufacturer-list-type-<?php echo $list_type['code'] ?>" ><?php echo $list_type['text']; ?></label>
                        <?php } else { ?>
                        <input disabled type="radio" name="filter[manufacturer][list_type]" value="<?php echo $list_type['code'] ?>" id="input-tf-filter-manufacturer-list-type-<?php echo $list_type['code'] ?>">
                        <label for="input-tf-filter-manufacturer-list-type-<?php echo $list_type['code'] ?>" ><?php echo $list_type['text']; ?></label>
                        <?php } ?>
                      <?php } ?>
                    </div>
                ...
                <!-- show search-->
                <div class="form-group">
                  <label class="col-xs-3 control-label" for="list-tf-filter-manufacturer-list-type"><?php echo $entry_show_search ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <?php foreach($list_search_status as $search_status){ ?>
                        <?php if($search_status['code'] == 0){ ?>
                        <input disabled type="radio" name="filter[manufacturer][search]" value="<?php echo $search_status['code'] ?>" id="input-tf-filter-manufacturer-list-type-<?php echo $search_status['code'] ?>" checked>
                        <label for="input-tf-filter-manufacturer-list-type-<?php echo $search_status['code'] ?>" ><?php echo $search_status['text']; ?></label>
                        <?php } else { ?>
                        <input disabled type="radio" name="filter[manufacturer][search]" value="<?php echo $search_status['code'] ?>" id="input-tf-filter-manufacturer-list-type-<?php echo $search_status['code'] ?>">
                        <label for="input-tf-filter-manufacturer-list-type-<?php echo $search_status['code'] ?>" ><?php echo $search_status['text']; ?></label>
                        <?php } ?>
                      <?php } ?>
                    </div>
                ...
                <!--Image width-->
                <div class="form-group">
                  <label class="col-xs-3 control-label" for="input-tf-filter-manufacturer-image-width"><?php echo $entry_image_width ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
                  <div class="col-xs-9">
                    <input disabled class="form-control" id="input-tf-filter-manufacturer-image-width" placeholder="<?php echo $entry_image_width ?>" type="number" name="filter[manufacturer][image_width]" >
                  </div>
                </div>
                
                <!--Image height-->
                <div class="form-group">
                  <label class="col-xs-3 control-label" for="input-tf-filter-manufacturer-image-height"><?php echo $entry_image_height ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
                  <div class="col-xs-9">
                    <input disabled class="form-control" id="input-tf-filter-manufacturer-image-height" placeholder="<?php echo $entry_image_height ?>" type="number" name="filter[manufacturer][image_height]" >
                  </div>
                </div>
              </div>
              ...
              <div id="tab-tf-filter-search" class="tab-pane fade">
                <div class="alert alert-warning"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> <?php echo $help_filter_pro ?></div>
                <!--Status-->
                <div class="form-group">
                  <label class="col-xs-3 control-label"><?php echo $entry_status ?></label>
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[search][status]" value="1" id="input-tf-filter-search-enabled" >
                      <label for="input-tf-filter-search-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[search][status]" value="0" id="input-tf-filter-search-disabled" checked>
                ...
                <div class="form-group">
                  ...
                  <?php foreach($languages as $language){ ?>
                    <div class="input-group inline"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                      <input disabled class="form-control" type="text" name="filter[search][title][<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_title ?>" >
                    </div>
                  <?php } ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <?php foreach($languages as $language){ ?>
                    <div class="input-group inline"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" placeholder="<?php echo $language['name']; ?>" /></span>
                      <input disabled class="form-control" type="text" name="filter[search][placeholder][<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_placeholder ?>" >
                    </div>
                  <?php } ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[search][description]" value="1" id="input-tf-filter-search-description-enabled" >
                      <label for="input-tf-filter-search-description-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[search][description]" value="0" id="input-tf-filter-search-description-disabled" checked>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[search][collapse]" value="1" id="input-tf-filter-search-collapse-enabled" >
                      <label for="input-tf-filter-search-collapse-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[search][collapse]" value="0" id="input-tf-filter-search-collapse-disabled" checked>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-xs-9">
                    <input disabled class="form-control" id="input-tf-filter-search-sort-order" placeholder="<?php echo $entry_sort_order ?>" type="number" name="filter[search][sort_order]" value="" >
                  </div>
                </div>
              </div>
...
<!--                <div class="form-group">
              ...
              <div id="tab-tf-filter-discount" class="tab-pane fade">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[discount][status]" value="1" id="input-tf-filter-discount-enabled" >
                      <label for="input-tf-filter-discount-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[discount][status]" value="0" id="input-tf-filter-discount-disabled" checked>
                ...
                <div class="form-group">
                  ...
                  <?php foreach($languages as $language){ ?>
                    <div class="input-group inline"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                      <input disabled class="form-control" type="text" name="filter[discount][title][<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_title ?>" >
                    </div>
                  <?php } ?>
                  </div>
                </div>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-xs-9">
                    <input disabled class="form-control" id="input-tf-filter-discount-sort-order" placeholder="<?php echo $entry_sort_order ?>" type="number" name="filter[discount][sort_order]" value="" >
                  </div>
                </div>
                <!-- collapse -->
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[discount][collapse]" value="1" id="input-tf-filter-discount-collapse-enabled" >
                      <label for="input-tf-filter-discount-collapse-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[discount][collapse]" value="0" id="input-tf-filter-discount-collapse-disabled" checked>
              ...
              <div id="tab-tf-filter-rating" class="tab-pane fade">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[rating][status]" value="1" id="input-tf-filter-rating-enabled" >
                      <label for="input-tf-filter-rating-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[rating][status]" value="0" id="input-tf-filter-rating-disabled" checked>
                ...
                <div class="form-group">
                  ...
                  <?php foreach($languages as $language){ ?>
                    <div class="input-group inline"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                      <input disabled class="form-control" type="text" name="filter[rating][title][<?php echo $language['language_id']; ?>]" value="" placeholder="<?php echo $entry_title ?>" >
                    </div>
                  <?php } ?>
                  </div>
                </div>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-xs-9">
                    <input disabled class="form-control" id="input-tf-filter-rating-sort-order" placeholder="<?php echo $entry_sort_order ?>" type="number" name="filter[rating][sort_order]" value="" >
                  </div>
                </div>
                <!--collapse-->
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[rating][collapse]" value="1" id="input-tf-filter-rating-collapse-enabled" >
                      <label for="input-tf-filter-rating-collapse-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[rating][collapse]" value="0" id="input-tf-filter-rating-collapse-disabled" checked>
              ...
              <div id="tab-tf-filter-filter" class="tab-pane fade">
                ...
                <!-- show search-->
                <div class="form-group">
                  <label class="col-xs-3 control-label" for="list-tf-filter-filter-list-type"><?php echo $entry_show_search ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <?php foreach($list_search_status as $search_status){ ?>
                        <?php if($search_status['code'] == -1){ ?>
                        <input disabled type="radio" name="filter[filter][search]" value="<?php echo $search_status['code'] ?>" id="input-tf-filter-filter-list-type-<?php echo $search_status['code'] ?>" checked>
                        <label for="input-tf-filter-filter-list-type-<?php echo $search_status['code'] ?>" ><?php echo $search_status['text']; ?></label>
                        <?php } else { ?>
                        <input disabled type="radio" name="filter[filter][search]" value="<?php echo $search_status['code'] ?>" id="input-tf-filter-filter-list-type-<?php echo $search_status['code'] ?>">
                        <label for="input-tf-filter-filter-list-type-<?php echo $search_status['code'] ?>" ><?php echo $search_status['text']; ?></label>
                        <?php } ?>
                      <?php } ?>
                    </div>
              ...
              <div id="tab-tf-filter-custom" class="tab-pane fade">
                <div class="alert alert-warning"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> <?php echo $help_filter_pro ?></div>
                <div class="alert alert-info"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $help_custom ?></div>
                <!--Status-->
                <div class="form-group">
                  <label class="col-xs-3 control-label" for="input-tf-filter-custom-status"><?php echo $entry_status ?></label>
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[custom][status]" value="1" id="input-tf-filter-custom-enabled" >
                      <label for="input-tf-filter-custom-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[custom][status]" value="0" id="input-tf-filter-custom-disabled" checked>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <?php foreach($list_search_status as $search_status){ ?>
                        <input disabled type="radio" name="filter[custom][search]" value="<?php echo $search_status['code'] ?>" id="input-tf-filter-custom-list-type-<?php echo $search_status['code'] ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <div class="mz-switch-field">
                      <input disabled type="radio" name="filter[custom][require_category]" value="1" id="input-tf-filter-custom-require-category-enabled" >
                      <label for="input-tf-filter-custom-require-category-enabled"><?php echo $text_enabled; ?></label>
                      <input disabled type="radio" name="filter[custom][require_category]" value="0" id="input-tf-filter-custom-require-category-disabled" checked>
      ...
      <div id="tab-tf-layout" class="tab-pane fade">
        <div class="alert alert-info"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $text_rate ?> <a href="#" class="close" data-dismiss="alert" aria-label="close"><i class="fa fa-times-circle" aria-hidden="true"></i></a></div>
        <div class="panel mz-panel-default">
          <div class="panel-heading"><?php echo $text_general ?></div>
          <div class="panel-body">
            <!--collapse by default-->
            <div class="form-group">
              <label class="col-xs-3 control-label"><?php echo $entry_collapse ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
              <div class="col-xs-9">
                <div class="mz-switch-field">
                  <input disabled type="radio" name="collapsed" value="1" id="input-collapsed-enabled" >
                  <label for="input-collapsed-enabled"><?php echo $text_enabled; ?></label>
                  <input disabled type="radio" name="collapsed" value="0" id="input-collapsed-disabled" checked>
            ...
            <!--Ajax-->
            <div class="form-group">
              <label class="col-xs-3 control-label"><?php echo $entry_ajax ?> <span class="label label-primary"><?php echo $text_pro ?></span></label>
              <div class="col-xs-9">
                <div class="mz-switch-field">
                  <input disabled type="radio" name="ajax" value="1" id="input-ajax-enabled" >
                  <label for="input-ajax-enabled"><?php echo $text_enabled; ?></label>
                  <input disabled type="radio" name="ajax" value="0" id="input-ajax-disabled" checked>
        ...
        <div class="panel mz-panel-default">
          ...
          <div class="panel-body">
            <div class="form-group">
              <label class="col-xs-3 control-label"><?php echo $entry_overflow ?> <span class="label label-primary"><?php echo $text_pro ?> </span></label>
              <div class="col-xs-9">
                <div class="mz-switch-field">
                  <?php foreach($overflow_types as $overflow_type) { ?>
                    <?php if($overflow_type['code'] == 'scroll'){ ?>
                    <input disabled type="radio" name="overflow" value="<?php echo $overflow_type['code'] ?>" id="input-overflow-<?php echo $overflow_type['code'] ?>" checked>
                    <label for="input-overflow-<?php echo $overflow_type['code'] ?>" ><?php echo $overflow_type['text']; ?></label>
                    <?php } else { ?>
                    <input disabled type="radio" name="overflow" value="<?php echo $overflow_type['code'] ?>" id="input-overflow-<?php echo $overflow_type['code'] ?>" >
                    <label for="input-overflow-<?php echo $overflow_type['code'] ?>"><?php echo $overflow_type['text']; ?></label>
                    <?php } ?>
                  <?php } ?>
                </div>
        ...
        <div class="panel mz-panel-default">
          <div class="panel-heading"><?php echo $text_filter_column ?> <span class="label label-primary"><?php echo $text_pro ?> </span></div>
          <div class="panel-body">
            <div class="form-group">
              <label class="col-xs-3 control-label" for="input-column-lg"><?php echo $entry_column_lg ?></label>
              <div class="col-xs-5">
                <div class="input-group">
                  <input disabled type="range" name="column_lg" min="1" max="6" value="1" id="input-column-lg" class="form-control" />
            ...
            <div class="form-group">
              ...
              <div class="col-xs-5">
                <div class="input-group">
                  <input disabled type="range" name="column_md" min="1" max="6" value="1" id="input-column-md" class="form-control" />
                  <span class="input-group-addon">1</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-xs-5">
                <div class="input-group">
                  <input disabled type="range" name="column_sm" min="1" max="6" value="1" id="input-column-sm" class="form-control" />
                  <span class="input-group-addon">1</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-xs-5">
                <div class="input-group">
                  <input disabled type="range" name="column_xs" min="1" max="6" value="1" id="input-column-xs" class="form-control" />
                  <span class="input-group-addon">1</span>
                </div>
              </div>
            </div>
