...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		foreach ($data['information_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "information_description SET information_id = '" . (int)$information_id . "', language_id = '" . (int)$language_id . "', title = '" . $this->db->escape($value['title']) . "', description = '" . $this->db->escape($value['description']) . "', description_additional = '" . $this->db->escape($value['description_additional']) . "', city = '" . $this->db->escape($value['city']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
	...
	public function getInformationDescriptions($information_id) {
		...
		foreach ($query->rows as $result) {
			$information_description_data[$result['language_id']] = array(
				...
				'description_additional'      => $result['description_additional'],
				'city'      => $result['city'],
