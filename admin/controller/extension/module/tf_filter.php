...
class ControllerExtensionModuleTfFilter extends Controller {
		...
		$this->document->setTitle($this->language->get('heading_title'));
                ...
                if (isset($this->request->get['module_id'])) {
                 ...
                 $header_data['buttons'][] = array( // Button get pro
                    'id' => 'button-pro',
                    'name' => $this->language->get('button_get_pro'),
                    'tooltip' => false,
                    'icon' => 'fa-diamond',
                    'class' => 'btn-warning',
                    'href' => 'https://www.opencart.com/index.php?route=marketplace/extension/info&extension_id=35570&filter_member=TemplateMaza',
                    'target' => '_black',
                    'form_target_id' => false,
                );
			...
			$module_setting = $this->model_setting_module->getModule($this->request->get['module_id']);
                ...
                // Text
                $data['help_custom'] = sprintf($this->language->get('help_custom'), 'http://flexi-filter.templatemaza.com/admin/index.php?route=extension/maza/tf_filter');
...
//                
        ...
        private function register_user($is_installed = 1){
                ...
                $ch = curl_init();
                curl_setopt($ch, CURLOPT_URL, "http://flexi-filter.templatemaza.com/flexi_filter_user.php");
