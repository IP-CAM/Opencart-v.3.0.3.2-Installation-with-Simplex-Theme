...
class ControllerExtensionModuleMinify extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/minify', 'user_token=' . $this->session->data['user_token'], true)
        );
        ...
        $data['action'] = $this->url->link('extension/module/minify', 'user_token=' . $this->session->data['user_token'], true);
        $data['cancel'] = $this->url->link('extension/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);
        $data['clear'] = $this->url->link('extension/module/minify/clear', 'user_token=' . $this->session->data['user_token'], true);
    ...
    public function clear() {
        ...
        $this->response->redirect($this->url->link('extension/module/minify', 'user_token=' . $this->session->data['user_token'], true));
    }
