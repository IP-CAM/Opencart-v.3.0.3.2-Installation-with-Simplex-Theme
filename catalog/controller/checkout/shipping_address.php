...
class ControllerCheckoutShippingAddress extends Controller {
	...
	public function save() {
		...
		if (!$json) {
			...
			if(!isset($this->request->post['shipping_address']) && isset($this->request->post['payment_address'])){
                $this->request->post['shipping_address'] = $this->request->post['payment_address'];
